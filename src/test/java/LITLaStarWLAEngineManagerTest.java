...
public class LITLaStarWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITLaStarWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITLaStarWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITLaStarWLAIW/InitOutcome.xml").getDocumentElement();
